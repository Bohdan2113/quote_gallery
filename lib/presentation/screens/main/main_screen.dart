                          ...
                          children: [
                            Expanded(
                              child: DropdownButtonFormField<String>(
                                menuMaxHeight: 130, 
                                initialValue: selectedAuthor.isEmpty
                                    ? null
                                    : selectedAuthor,
                                decoration: const InputDecoration(
                                  hintText: 'Всі автори',
                            ...
                            Expanded(
                              child: DropdownButtonFormField<String>(
                                menuMaxHeight: 130, 
                                initialValue: selectedTag.isEmpty
                                    ? null
                                    : selectedTag,
                                decoration: const InputDecoration(
                                  hintText: 'Всі теги',
                ...
                child: quotes.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isOwner =
                              quote.userId == MockData.currentUser?.email;
                          ...
                          return QuoteCard(
                            ...
                            onEdit: () {
                              // Заглушка для редагування
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Редагування (заглушка)'),
                                ),
                              );
                            },
                            onDelete: () {
